...
import type { BlockingsRepository, FollowingsRepository, MutingsRepository, RenoteMutingsRepository, MiUserProfile, UserProfilesRepository, UsersRepository, MiFollowing, ChannelFollowingsRepository } from '@/models/_.js';
...
export class CacheService implements OnApplicationShutdown {
	...
	public userChannelFollowingsCache: RedisKVCache<Set<string>>;
