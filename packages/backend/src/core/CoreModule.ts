...
import { EmojiRequestEntityService } from './entities/EmojiRequestEntityService.js';
...
const $EmojiRequestEntityService: Provider = { provide: 'EmojiRequestEntityService', useExisting: EmojiRequestEntityService };
